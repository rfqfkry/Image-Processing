...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Apply thresholding to the disparity map to create a binary mask
        _, binary_mask = cv.threshold(disparity, 100, 255, cv.THRESH_BINARY)
        ...
        rd_binary_mask = cv.resize(binary_mask, (512, 512))
        ...
        cv.imshow("Binary Mask", rd_binary_mask)  # Display the binary mask
