...
if __name__ == "__main__":
    ...
    while True:
       ...
       # Apply a colormap to the filtered disparity map
        colormap_depth = cv.applyColorMap(depth_normalized, cv.COLORMAP_JET)
        rd_dep = cv.resize(colormap_depth, (512, 512))
